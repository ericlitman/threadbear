...
For a failed title wave, the controller leaves pending proposals fail-closed and reports them to the home. It does not claim that its title calls settled or use `--settled`.
