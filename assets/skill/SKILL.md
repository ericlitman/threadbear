...
> ThreadBear is installed. Existing tasks with clear enough history will gain icons over the next several minutes; a small sparkle marks a first read and disappears on that task's next turn. Unclear tasks stay untouched. Keep working, and restart Codex when ready.
